/*
These variables contian directions for where to fined the css formatting. The %data% sections have been replaced in resumebuilder.js
*/
...
//my code - creating the functionality for the internationalize button
function inName(passedname) {

    var splitName = passedname.split(" ");
    var lastName = splitName[1];
    lastName = lastName.toUpperCase();
    var iName = splitName[0] + " " + lastName;
    return iName;
...
/*
This is the (NOT) fun part. Here's where we generate the custom Google Map for the website.
